...
var _modal = require("part:@sanity/components/modal");
...
function DefaultDialogChildren(props) {
  ...
  return /*#__PURE__*/_react.default.createElement(_containerQuery.ContainerQuery, {
    ...
    "data-dialog-size": size // style={{opacity: modal.depth < modal.size ? 0 : 1}}

  }, /*#__PURE__*/_react.default.createElement("div", {
    className: _defaultStyle.default.overlay
  }), /*#__PURE__*/_react.default.createElement(_clickOutside.ClickOutside, {
    onClickOutside: modal.depth === modal.size ? handleClickOutside : undefined
  ...
  , {
    onEscape: event => (modal.depth === modal.size || event.shiftKey) && handleEscape(event)
  }), /*#__PURE__*/_react.default.createElement("div", {
...
function DefaultDialog(props) {
  return /*#__PURE__*/_react.default.createElement(_modal.Modal, null, /*#__PURE__*/(0, _react.createElement)(DefaultDialogChildren, props));
}
